...
import { navLinks } from '../constatants';
    ...
    return (
        <nav className="w-full flex py-6 justify-between items-center navbar">
            ...
            <div className="sm:hidden flex flex-1 justify-end items-center">
                ...
                />
                <div className={`${toggle ? 'flex' : 'hidden'} p-6 bg-black-gradient absolute top-20 right-0 mx-5 my-2 min-w-[140px] rounded-xl sidebar`}
                >
